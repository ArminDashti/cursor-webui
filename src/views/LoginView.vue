...
async function onSubmit() {
  ...
  try {
    ...
    const redirect = typeof route.query.redirect === 'string' ? route.query.redirect : '/endpoints'
  ...
  <div class="mx-auto flex min-h-full max-w-md items-center px-4 py-14">
    <Card class="w-full">
      <CardHeader>
        ...
        <CardDescription>Sign in to manage endpoints and gateway API keys.</CardDescription>
      </CardHeader>
      <CardContent>
